...
from .dataset_gen import DATASETS, PromptRecord, generate_task_dataset
...
def load_prompt_records(input_path: Path) -> list[PromptRecord]:
    """Load prompt records from a JSON file produced by ``dataset_gen.py``."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Optional prompt-record JSON input generated by dataset_gen.py.",
    )
    parser.add_argument(
        "--dataset",
