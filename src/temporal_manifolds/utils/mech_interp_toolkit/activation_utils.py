...
from temporal_manifolds.activations.extraction_policy import validate_model_hook_request
...
def get_activations_and_grads(
    ...
    validate_model_hook_request(layer_components=layer_components, positions=positions)
