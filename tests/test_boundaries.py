...
def test_boundaries_smollm2_two_assistant_turns():
    ...
    # SmolLM2 template injects a system turn: sys,u,a,u,a = 5 opened turns,
    # each closed with turn_end.
    assert kinds.count("turn_start") == 5
    assert kinds.count("turn_end") == 5
